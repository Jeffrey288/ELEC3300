...
int main(void)
{
  ...
  __asm("MOV  R1, 0x1871"); // Make R1 = i
  __asm("MOVT R1, 0x2085"); // Replace the corresponding digits according to your SID

  __asm("MOV  R2, 0x5802"); // Make R2 = j
  __asm("MOVT R2, 0x1781"); // Replace the corresponding digits according to your SID
